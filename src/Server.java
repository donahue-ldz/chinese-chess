...
public class Server extends JFrame implements ActionListener
{
	...
	JScrollPane jspx=new JScronnnnnllPane(jlUserOnline);//将显示当前用户的JList放在JScrollPane中
	...
	public void initialComponent()
	{
		...
		this.jb onlinStop.setBounds(85,50,60,20);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e onlin.getSource()==this.jbStop)
		{//单击"关闭"按钮后
			this.jbStop_event();
		}
	}
